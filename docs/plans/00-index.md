...
| File                                                     | Feature Group        | Phases      | Status      | Description                                                                                                                                                                                                    |
| -------------------------------------------------------- | -------------------- | ----------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [01-project-foundation.md](./01-project-foundation.md)   | Project Foundation   | 1.1 - 1.8   | Done        | Tauri scaffolding, project structure, developer tooling                                                                                                                                                        |
| [02-database-foundation.md](./02-database-foundation.md) | Database             | 2.1 - 2.6   | Done        | SQLite setup, schema, migrations                                                                                                                                                                               |
| [03-file-scanning.md](./03-file-scanning.md)             | File Scanning        | 3.1 - 3.10  | Done        | Directory traversal, file metadata collection, folder picker UI                                                                                                                                                |
| [04-duplicate-detection.md](./04-duplicate-detection.md) | Detection            | 4.1 - 4.10  | Done        | Size grouping, partial/full hashing, BLAKE3, empty file handling (4.2.3), live streaming events (4.3.3)                                                                                                        |
| [05-results-ui.md](./05-results-ui.md)                   | Results UI           | 5.1 - 5.8   | Done        | Master-detail layout, duplicate groups display, live streaming subscription (5.1.5), **path truncation with middle ellipsis + hover tooltip**, **creation AND modified dates**                                 |
| [06-selection-deletion.md](./06-selection-deletion.md)   | Selection & Deletion | 6.1 - 6.10  | Done        | Selection logic (incl. path depth), batch deletion, trash integration, **stronger delete-all-copies warning with checkbox confirmation**, **deletion history viewing UI**                                      |
| [07-scan-progress.md](./07-scan-progress.md)             | Progress & Controls  | 7.1 - 7.6   | Not Started | Progress display with ETA (7.1.2 total count estimation), pause/resume, persistence                                                                                                                            |
| [08-settings-protected.md](./08-settings-protected.md)   | Settings             | 8.1 - 8.6   | Not Started | Theme, parallelism, protected folders, **last scan settings restoration on app launch**                                                                                                                        |
| [09-file-operations.md](./09-file-operations.md)         | File Operations      | 9.1 - 9.7   | Not Started | Open, reveal, copy path, view file info, context menu                                                                                                                                                          |
| [10-filtering-search.md](./10-filtering-search.md)       | Filtering & Search   | 10.1 - 10.8 | Not Started | File type filters, search, thumbnails                                                                                                                                                                          |
| [11-keyboard-nav.md](./11-keyboard-nav.md)               | Keyboard & A11y      | 11.1 - 11.6 | Not Started | Keyboard shortcuts, focus management                                                                                                                                                                           |
| [12-permissions.md](./12-permissions.md)                 | Permissions          | 12.1 - 12.6 | Not Started | Permission wizard, Full Disk Access guide (Windows permissions deferred to polish stage)                                                                                                                       |
| [13-error-handling.md](./13-error-handling.md)           | Error Handling       | 13.1 - 13.7 | Not Started | Skip/retry, disk full handling, error display, recovery, **clearer file moved/deleted error messaging with user-friendly explanations**, **detailed disk I/O throttling with adaptive queue depth monitoring** |
| [14-platform-polish.md](./14-platform-polish.md)         | Polish & Final       | 14.1 - 14.8 | Not Started | Native styling, **Windows support**, platform tweaks, final E2E, **comprehensive E2E tests covering actual duplicate detection logic**                                                                         |
| [15-system-tray.md](./15-system-tray.md)                 | System Tray          | 15.1 - 15.8 | Not Started | Minimize to tray feature, tray icon and menu, **tray tooltip with scan progress % and ETA**                                                                                                                    |
